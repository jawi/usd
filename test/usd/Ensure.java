...
public class Ensure
{
   ...
   */
  public synchronized void waitForStep( final int aNr, final long aTimeout )
  {
    final long initialTimeout = aTimeout;
    ...
    final long end = System.currentTimeMillis() + aTimeout;
    while ( ( this.step < aNr ) && ( System.currentTimeMillis() < end ) )
    {
      try
      {
        wait( RESOLUTION );
